...
> This software has been entirely developped using ChatGPT, OpenCode, Spec Kit and local LM Studio with Qwen 2.5 Coder 14B Instruct (and many researches on internet).  
> This may have some unusual ways of coding.  
> If you spot anything, do not hesitate to read through this README, [CONTRIBUTING](https://github.com/Lord-ZuzurNC/Whaaaam?tab=contributing-ov-file), [SECURITY](https://github.com/Lord-ZuzurNC/Whaaaam?tab=security-ov-file) and create an issue to make it more human and secure.
...
[![Python](https://img.shields.io/badge/Python-3.10–3.12-blue?logo=python)](https://www.python.org/) [![Flask](https://img.shields.io/badge/Backend-Flask-000?logo=flask)](https://flask.palletsprojects.com/) [![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/Lord-ZuzurNC/Whaaaam?tab=MIT-1-ov-file) [![GitHub Workflow Status](https://github.com/Lord-ZuzurNC/Whaaaam/actions/workflows/python-app.yml/badge.svg?event=push)](https://github.com/Lord-ZuzurNC/Whaaaam/actions)

---

## 💡 Overview

Tired of checking **every single mod page** to see if they all support the same Minecraft version or loader?  
**Whaaaam** automates that for you.
...
```bash
git clone https://github.com/Lord_ZuzurNC/Whaaaam.git
cd Whaaaam
```
...
You’re building a modpack for Minecraft 1.20.1 and want to make sure all mods support NeoForge.  
...
Please read the (very short) [contributing guideline](https://github.com/Lord-ZuzurNC/Whaaaam?tab=contributing-ov-file).

---

## 📜 License

Released under the [MIT License](https://github.com/Lord-ZuzurNC/Whaaaam?tab=MIT-1-ov-file)  
© 2025 – Lord_ZuzurNC
